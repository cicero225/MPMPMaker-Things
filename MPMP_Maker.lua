...
function CreateMP()
	...
	for textIndex=1,10 do
		CopyTextDatabase(textFileNameList[textIndex],langList[textIndex])
	end	
...
function CopyTextDatabase(fileName,langName)
	...
	CleanWrite( fileName, "	</Language_" .. langName .. "> \n</GameData>", false)
end
